...
export function BenchmarksPage() {
  ...
  const [intelPeriod, setIntelPeriod] = useState<"weekly" | "quarterly">(
    "weekly",
  );
            ...
            <Panel>
              ...
              {optionsQuery.isError && (
                <Alert severity="error">
                  Failed to load benchmark options.
                </Alert>
              )}
                    ...
                    <>
                      {!resultQuery.data.available ? (
                        <Alert severity="info" sx={{ mb: 2 }}>
                          Not enough closed roles yet (
                          {resultQuery.data.sampleSize} found, need ≥{" "}
                          {optionsQuery.data.minSample}). Try a broader title or
                          another city.
                        </Alert>
                      ) : null}
                      ...
                      <Metrics>
                        <Metric>
                          ...
                          <MetricValue>
                            ...
                            {resultQuery.data.marketMedianTtfDays != null
                              ? "d"
                              : ""}
                          </MetricValue>
                        </Metric>
                        ...
                        <Metric>
                          ...
                          <MetricValue>
                            {resultQuery.data.openRoleCount}
                          </MetricValue>
                        </Metric>
                        <Metric>
                          <MetricLabel>CLOSED ROLES</MetricLabel>
                          <MetricValue>
                            {resultQuery.data.sampleSize}
                          </MetricValue>
                        </Metric>
                        <Metric>
                          <MetricLabel>ROLES WITH SALARY</MetricLabel>
                          <MetricValue>
                            {resultQuery.data.salary.sampleSize}
                          </MetricValue>
                        </Metric>
                      </Metrics>
                      ...
                      <Hint>
                        From {resultQuery.data.salary.sampleSize} ads with
                        min+max salary · lookback{" "}
                        {resultQuery.data.lookbackDays}d
